...
public final class memberEnrollForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <button type=\"submit\" class=\"btn btn-primary\" id=\"enrollBtn\" disabled>회원가입</button>\r\n");
      ...
      out.write("    \t\t\t// 우선 최소 5글자 이상으로 입력했을때만 ajax 요청해서 중복체크 하도록\r\n");
      ...
      out.write("    \t\t\t\t\t\tif(result == \"N\"){ // 사용불가\r\n");
      out.write("    \t\t\t\t\t\t\t// 메세지 빨간색 출력, 버튼 비활성화\r\n");
      out.write("    \t\t\t\t\t\t\t$(\"#checkResult\").show();\r\n");
      out.write("    \t\t\t\t\t\t\t$(\"#checkResult\").css(\"color\",\"red\").text(\"중복된 아이디가 존재합니다. 다시 입력해주세요.\");\r\n");
      ...
      out.write("    \t\t\t\t\t\tconosole.log(\"아이디 중복체크 ajax 통신 실패\");\r\n");
      out.write("    \t\t\t\t\t}\r\n");
      out.write("    \t\t\t\t\t\r\n");
      out.write("    \t\t\t\t})\r\n");
      out.write("    \t\t\t\t\r\n");
      out.write("    \t\t\t} else{ // 아이디가 5글자 미만일경우 => 유효하지 않아 가입자체 못하게 함\r\n");
      out.write("    \t\t\t\t$(\"#enrollBtn\").attr(\"disabled\", true);\r\n");
